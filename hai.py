...
BOT_TOKEN = "7909817540:AAFew--Pz9y6I6z2nLms0Mz3OZwEG7dKq48"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_owner(user_id) or is_admin(user_id):
        await update.message.reply_text(
            ...
            "• /listgrp - ʟɪsᴛ ɢʀᴏᴜᴘs\n"
            "• /addgroup <ɢʀᴏᴜᴘ_ɪᴅ> <ɴᴀᴍᴇ> - ᴀᴅᴅ ɴᴇᴡ ɢʀᴏᴜᴘ\n"
            "• /removegroup <ɢʀᴏᴜᴘ_ɪᴅ> - ʀᴇᴍᴏᴠᴇ ᴀ ɢʀᴏᴜᴘ\n"
            "• /maintenance <ᴏɴ/ᴏғғ>\n"
...
async def addgroup_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if len(context.args) < 2:
        await update.message.reply_text(
            "👥 **ᴀᴅᴅ ɢʀᴏᴜᴘ**\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "ᴜsᴀɢᴇ: /addgroup <ɢʀᴏᴜᴘ_ɪᴅ> <ɴᴀᴍᴇ>\n"
            "ᴇxᴀᴍᴘʟᴇ: /addgroup -100123456789 MyBotGroup"
        )
        return
...
async def removegroup_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if len(context.args) < 1:
        await update.message.reply_text(
            "🗑️ **ʀᴇᴍᴏᴠᴇ ɢʀᴏᴜᴘ**\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "ᴜsᴀɢᴇ: /removegroup <ɢʀᴏᴜᴘ_ɪᴅ>\n"
            "ᴇxᴀᴍᴘʟᴇ: /removegroup -100123456789"
        )
        return
    ...
    if group_id in groups:
        removed_name = groups[group_id].get('name', 'Unknown')
        del groups[group_id]
        save_groups(groups)
        await update.message.reply_text(
            f"✅ **ɢʀᴏᴜᴘ ʀᴇᴍᴏᴠᴇᴅ**\n"
        ...
        await update.message.reply_text("❌ ɢʀᴏᴜᴘ ɴᴏᴛ ғᴏᴜɴᴅ ɪɴ ʟɪsᴛ.")
...
def main():
    ...
    application.add_handler(CommandHandler("addgroup", addgroup_command)) # Naya command
    application.add_handler(CommandHandler("removegroup", removegroup_command)) # Naya command
